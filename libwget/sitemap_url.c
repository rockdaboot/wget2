...
{
  wget_vector_t * sitemap_urls, *urls;
};

static void
_sitemap_get_url (void *context, int flags, const char *dir,
                  const char *attr G_GNUC_WGET_UNUSED, const char *val,
                  size_t len, size_t pos G_GNUC_WGET_UNUSED)
{
                              ...
                              wget_vector_t ** sitemap_urls)
{
  ...
  wget_xml_parse_buffer (sitemap, _sitemap_get_url, &context,
