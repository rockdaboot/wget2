...
G_GNUC_WGET_PRINTF_FORMAT (2, 0)
  ...
  _logger_vprintf_func (const wget_logger_t * logger, const char *fmt,
                        va_list args)
{
  char sbuf[4096];
  wget_buffer_t buf;
...
static void
_logger_write_func (const wget_logger_t * logger, const char *buf, size_t len)
{
  logger->func (buf, len);
}
...
G_GNUC_WGET_PRINTF_FORMAT (2, 0)
  G_GNUC_WGET_NONNULL ((1, 2))
  _logger_vprintf_file (const wget_logger_t * logger, const char *fmt,
                        va_list args)
{
...
static void
_logger_write_file (const wget_logger_t * logger, const char *buf, size_t len)
{
...
G_GNUC_WGET_PRINTF_FORMAT (2, 0)
  G_GNUC_WGET_NONNULL ((1, 2))
  _logger_vprintf_fname (const wget_logger_t * logger, const char *fmt,
                         va_list args)
{
...
static void
_logger_write_fname (const wget_logger_t * logger, const char *buf,
                     size_t len)
{
  FILE *fp = fopen (logger->fname, "a");
...
void
wget_logger_set_func (wget_logger_t * logger,
...
FILE *
wget_logger_get_stream (wget_logger_t * logger)
{
...
const char *
wget_logger_get_file (wget_logger_t * logger)
{
