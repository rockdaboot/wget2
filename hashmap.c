...
void *hashmap_put_noalloc(HASHMAP *h, const void *key, const void *value)
{
	ENTRY *entry;
...
void *hashmap_put(HASHMAP *h, const void *key, size_t keysize, const void *value, size_t valuesize)
{
