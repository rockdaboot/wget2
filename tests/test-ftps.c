...
main (void)
{
  ...
  wget_test_start_server (WGET_TEST_RESPONSE_URLS, &urls, countof (urls), WGET_TEST_FTP_IO_UNORDERED, &io, countof (io), WGET_TEST_FTPS_IMPLICIT, 1,  // use TLS connections right away, no AUTH
                          0);
