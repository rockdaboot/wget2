...
main (void)
{
  wget_test_url_t urls[] = {
    {.name = "/index.html",
     ...
     " <a href=\"picture_A.jpeg\">Picture A</a>." "</p></body></html>",
     .headers = {
    ...
    {.name = "/secondpage.html",
     ...
     " <a href=\"picture_B.JpeG\">Picture B</a>."
     " <a href=\"picture_c.png\">Picture C</a>." "</p></body></html>",
     .headers = {
        "Content-Type: text/html",
      }
    },
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --accept '.jpeg'",
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --reject '.jpeg'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --accept '.jpeg' --ignore-case",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --reject '.jpeg' --ignore-case",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  // --accept using wildcards
  wget_test (WGET_TEST_OPTIONS, "-r -nH --accept '*picture*'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  // --reject using wildcards
  wget_test (WGET_TEST_OPTIONS, "-r -nH --reject '*picture*'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  // --accept using wildcards
  wget_test (WGET_TEST_OPTIONS, "-r -nH --accept '*picture_[ab]*'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  // --reject using wildcards
  wget_test (WGET_TEST_OPTIONS, "-r -nH --reject '*picture_[ab]*'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS,
             "-r -nH --accept '*picture_a*' --accept '*picture_c*'",
             WGET_TEST_REQUEST_URL, "index.html",
  ...
  // --reject using wildcards
  wget_test (WGET_TEST_OPTIONS,
             "-r -nH --reject '*picture_a*' --reject '*picture_c*'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0, WGET_TEST_EXPECTED_FILES,
             &(wget_test_file_t[])
             {
