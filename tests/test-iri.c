...
main (void)
{
  wget_test_url_t urls[] = {
    {.name = "/index.html",
     .code = "200 Dontcare",
     .body =
     "Link to page 1 <a href=\"http://localhost:{{port}}/p1_fran" ccedilla_l15
     "ais.html\">La seule page en fran&ccedil;ais</a>."
     "Link to page 3 <a href=\"http://localhost:{{port}}/p3_" eurosign_l15
     eurosign_l15 eurosign_l15 ".html\">My tailor is rich</a>.",
     .headers = {
    ...
    {.name = "/p1_fran%C3%A7ais.html",  // UTF-8 encoded
     ...
     "<p>Link to page 2 <a href=\"http://localhost:{{port}}/p2_" eacute_l15
     eacute_l15 "n.html\">Die enkele nerderlangstalige pagina</a>."
     "</p></body></html>",
     .headers = {
    ...
    {.name = "/p2_%C3%A9%C3%A9n.html",  // UTF-8 encoded
     ...
     "<a href=\"http://localhost:{{port}}/p4_m" eacute_u8 eacute_u8
     "r.html\">M&eacute&eacute;r</a>" "</p></body></html>",
     .headers = {
  ...
  wget_test (
             ...
             WGET_TEST_OPTIONS,
             "--iri -e robots=on --trust-server-names --restrict-file-names=nocontrol -nH -r",
