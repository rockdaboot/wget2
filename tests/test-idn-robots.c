...
main (void)
{
  ...
  snprintf (options, sizeof (options),
            "--iri -e robots=on -rH -e http_proxy=localhost:%d --local-encoding=EUC-JP http://"
            euc_jp_hostname "/", wget_test_get_http_server_port ());
  ...
  snprintf (options, sizeof (options),
            "--iri -e robots=on -rH -e http_proxy=localhost:%d --local-encoding=UTF-8 http://"
            utf8_hostname "/", wget_test_get_http_server_port ());
