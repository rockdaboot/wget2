...
main (void)
{
  wget_test_url_t urls[] = {
    {.name = "/index.html",
     ...
     " <a href=\"secondpage.html\">second page</a>." "</p></body></html>",
     .headers = {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --follow-tags 'img/data-500px'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --follow-tags 'img'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS,
             "-r -nH --follow-tags 'img/data-500px,img/data-highres'",
             WGET_TEST_REQUEST_URL, "index.html",
  ...
  // --follow-tags two entries
  wget_test (WGET_TEST_OPTIONS,
             "-r -nH --follow-tags 'img/data-highres,img/data-500px'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0, WGET_TEST_EXPECTED_FILES,
             &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --ignore-tags 'img/src'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --ignore-tags 'img'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS, "-r -nH --ignore-tags 'img/src,a/href'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  // --ignore-tags two entries
  wget_test (WGET_TEST_OPTIONS, "-r -nH --ignore-tags 'a/href,img/src'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0,
             WGET_TEST_EXPECTED_FILES, &(wget_test_file_t[])
             {
  ...
  wget_test (WGET_TEST_OPTIONS,
             "-r -nH --ignore-tags 'img/src' --follow-tags='img/data-500px'",
             WGET_TEST_REQUEST_URL, "index.html",
             WGET_TEST_EXPECTED_ERROR_CODE, 0, WGET_TEST_EXPECTED_FILES,
             &(wget_test_file_t[])
             {
