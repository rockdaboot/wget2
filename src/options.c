...
struct option
{
  ...
  void *var;
  int (*parser) (option_t opt, const char *const *argv, const char *val);
  int args;
  char short_name;
};

static int G_GNUC_WGET_NORETURN
print_help (G_GNUC_WGET_UNUSED option_t opt,
            G_GNUC_WGET_UNUSED const char *const *argv,
            G_GNUC_WGET_UNUSED const char *val)
{
  puts ("Wget V" PACKAGE_VERSION
        " - multithreaded metalink/file/website downloader written in C\n"
  ...
  puts ("HTTP related options:\n"
        ...
        "\n");
  puts ("HTTPS (SSL/TLS) related options:\n"
...
static int
parse_integer (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
               const char *val)
{
...
static int
parse_numbytes (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
                const char *val)
{
  if (val)
    {
...
static int
parse_string (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
              const char *val)
{
...
static int
parse_stringset (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
                 const char *val)
{
...
static int
parse_stringlist (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
                  const char *val)
{
...
_add_tag (wget_vector_t * v, const char *begin, const char *end)
{
  wget_html_tag_t tag;
  ...
  if ((attribute = memchr (begin, '/', end - begin)))
    {
      ...
      tag.attribute =
        strndup (attribute + 1, (end - begin) - (attribute - begin) - 1);
    }
  else
    {
...
_compare_tag (const wget_html_tag_t * t1, const wget_html_tag_t * t2)
{
  int n;
...
static int
parse_taglist (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
               const char *val)
{
  wget_vector_t *v = *((wget_vector_t **) opt->var);
...
static int
parse_bool (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
            const char *val)
{
  if (opt->var)
    {
      if (!val)
        *((char *) opt->var) = 1;
      else if (!strcmp (val, "1") || !strcasecmp (val, "y")
               || !strcasecmp (val, "yes") || !strcasecmp (val, "on"))
        *((char *) opt->var) = 1;
      else if (!strcmp (val, "0") || !strcasecmp (val, "n")
...
static int
parse_mirror (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
              const char *val)
{
...
static int
parse_timeout (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
               const char *val)
{
  double fval;
          ...
          if (modifier)
            {
              switch (tolower (modifier))
                ...
                case 'd':
                  ...
                  break;
                default:
                  error_printf_exit (_("Invalid time specifier in '%s'\n"),
                                     val);
                }
            }
          else
  ...
  if (opt->var)
  ...
  else
    {
      ...
      config.connect_timeout =
        config.dns_timeout = config.read_timeout = (int) fval;
    }

  return 0;
}

static int G_GNUC_WGET_PURE
G_GNUC_WGET_NONNULL ((1))
  parse_cert_type (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
                   const char *val)
{
...
static int G_GNUC_WGET_PURE
G_GNUC_WGET_NONNULL ((1))
  parse_restrict_names (option_t opt,
                        G_GNUC_WGET_UNUSED const char *const *argv,
                        const char *val)
{
...
static int
parse_n_option (G_GNUC_WGET_UNUSED option_t opt,
                G_GNUC_WGET_UNUSED const char *const *argv, const char *val)
{
  if (val)
    {
      const char *p;
...
static int
parse_prefer_family (option_t opt, G_GNUC_WGET_UNUSED const char *const *argv,
                     const char *val)
{
...
static int parse_execute (option_t opt,
                          G_GNUC_WGET_UNUSED const char *const *argv,
                          const char *val);
...
static const struct option options[] = {
  ...
  {"restrict-file-names", &config.restrict_file_names, parse_restrict_names,
   1, 0},
...
static int G_GNUC_WGET_PURE G_GNUC_WGET_NONNULL_ALL
opt_compare (const void *key, const void *option)
{
  return strcmp ((const char *) key, ((const option_t) option)->long_name);
}

static int G_GNUC_WGET_PURE G_GNUC_WGET_NONNULL_ALL
opt_compare_execute (const void *key, const void *option)
{
...
static int
G_GNUC_WGET_NONNULL ((1))
  set_long_option (const char *name, const char *value)
{
  option_t opt;
  int invert = 0, ret = 0;
  ...
  opt =
    bsearch (name, options, countof (options), sizeof (options[0]),
             opt_compare);
  if (!opt)
    {
...
static int
parse_execute (G_GNUC_WGET_UNUSED option_t opt,
               G_GNUC_WGET_UNUSED const char *const *argv, const char *val)
{
...
static int
_parse_option (char *linep, char **name, char **val)
{
  int quote;
...
static int
G_GNUC_WGET_NONNULL ((1))
  _read_config (const char *cfgfile, int expand)
{
          ...
          if (!strcmp (name, "include"))
            {
              if (++level > 20)
                error_printf_exit (_
                                   ("Config file recursion loop detected in %s\n"),
                                   cfgfile);
      ...
      for (it = 0; it < countof (options); it++)
        {
          if (options[it].short_name > 0)
            shortcut_to_option[(unsigned char) options[it].short_name] =
              it + 1;
        }
    }
          ...
          for (pos = 1; argp[pos]; pos++)
            {
              ...
              if (isalnum (argp[pos])
                  && (idx = shortcut_to_option[(unsigned char) argp[pos]]))
                {
                  opt = &options[idx - 1];
                  // info_printf("opt=%p [%c]\n",(void *)opt,argp[pos]);
                  // info_printf("name=%s\n",opt->long_name);
...
init (int argc, const char *const *argv)
{
  ...
  config.domains =
    wget_vector_create (16, -2, (int (*)(const void *, const void *)) strcmp);
  ...
  if (config.print_version)
    {
      info_printf ("Wget " PACKAGE_VERSION
                   " - C multithreaded metalink/file/website downloader\n\n");
      info_printf ("+digest"
  ...
  // SSL settings
  wget_ssl_set_config_int (WGET_SSL_CHECK_CERTIFICATE,
  ...
  wget_ssl_set_config_string (WGET_SSL_SECURE_PROTOCOL,
  ...
  wget_ssl_set_config_string (WGET_SSL_OCSP_CACHE,
                              (const char *) config.ocsp_db);
  if (config.http2)
    wget_ssl_set_config_string (WGET_SSL_ALPN, "h2,h2-16,h2-14,http/1.1");
...
selftest_options (void)
{
  ...
  for (it = 0; it < countof (options); it++)
    {
      option_t opt =
        bsearch (options[it].long_name, options, countof (options),
                 sizeof (options[0]), opt_compare);
      if (!opt)
        {
